...
- [《AI 编程必备 Skills 推荐》](./ai-coding/programmer-essential-skills.md)：实战分享 6 个 AI 编程 Skills，覆盖 TDD 开发流程、代码审查、UI 设计、网页自动化与 Skill 开发
...
- [AI 编程必备 Skills 推荐：TDD、代码审查与网页自动化实战](./ai-coding/programmer-essential-skills.md) - 实战分享 6 个 AI 编程 Skills，覆盖 TDD 开发流程、代码审查、UI 设计、网页自动化与 Skill 开发
